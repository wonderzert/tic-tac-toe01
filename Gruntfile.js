...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        typescript: {
            base: {
                src: ['src/ts/**/*.ts'], // which files to select
        ...
        copy: {
            dev: {
                files: [
                    ...
                    {expand: true, cwd: 'src/html/dev-dist', src: ['index.html'], dest: 'build/dev-dist/'},
            ...
            dist: {
                files: [
                    ...
                    {expand: true, cwd: 'src/html/dist', src: ['index.html'], dest: 'build/dist/'},
